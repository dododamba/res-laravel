    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validated = $request->validate([
                ...
                'taxe_operateur_id'    => 'nullable',
                'operateur_id'         => 'nullable|string',
                'taxe_nom'            => 'nullable|string',
                'selected_tax_type_id' => 'nullable|string',
                'taxe_code'           => 'nullable|string',
    ...
    public function syncBatch(Request $request): JsonResponse
    {
        try {
            $validated = $request->validate([
                ...
                'payments.*.taxe_operateur_id'  => 'nullable',
                'payments.*.operateur_id'       => 'nullable|string',
                'payments.*.taxe_nom'            => 'nullable|string',
                'payments.*.selected_tax_type_id' => 'nullable|string',
                'payments.*.taxe_code'           => 'nullable|string',
