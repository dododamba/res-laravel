...
@section('page_title', 'Modifier le Quartier : ' . $entity->nom)
@section('page_subtitle', 'Édition de l\'aire administrative et de sa supervision')

@section('actions')
    <a href="{{ route('quartier.show', $entity) }}" class="btn btn-sm btn-light">
